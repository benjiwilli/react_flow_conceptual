...
export const CATEGORY_COLORS: Record<NodeCategory, { bg: string; border: string; text: string; light: string }> = {
  learning: {
    bg: "bg-node-learning",
    border: "border-node-learning",
    text: "text-node-learning",
    light: "bg-node-learning/10",
  },
  ai: {
    bg: "bg-node-ai",
  ...
  scaffolding: {
    bg: "bg-node-scaffolding",
    border: "border-node-scaffolding",
    text: "text-node-scaffolding",
    light: "bg-node-scaffolding/10",
  },
  interaction: {
    bg: "bg-node-interaction",
    border: "border-node-interaction",
    text: "text-node-interaction",
    light: "bg-node-interaction/10",
  },
  flow: {
    bg: "bg-node-flow",
    border: "border-node-flow",
    text: "text-node-flow",
    light: "bg-node-flow/10",
  },
  output: {
    bg: "bg-node-output",
    border: "border-node-output",
    text: "text-node-output",
    light: "bg-node-output/10",
  },
}
