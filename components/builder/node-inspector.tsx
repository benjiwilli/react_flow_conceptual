...
import type { SubjectArea } from "@/lib/types/curriculum"
      ...
      <Tabs defaultValue="config" className="flex-1 flex flex-col">
        ...
        <ScrollArea className="flex-1">
          <TabsContent value="config" className="p-4 mt-0">
            <NodeConfigForm node={node} updateData={updateData} />
          </TabsContent>
...
type ConfigProps = {
  data: ConfigData
  updateData: (updates: ConfigData) => void
}
...
function StudentProfileConfig({ data, updateData }: ConfigProps) {
  const profileData = data as Partial<StudentProfileNodeData>
    ...
    <>
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => updateData({ gradeLevel: value as GradeLevel })}
        >
          <SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={String(profileData.elpaLevel || "")}
          onValueChange={(value) => updateData({ elpaLevel: parseInt(value) as ELPALevel })}
        >
          <SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) => updateData({ primaryLanguage: value as SupportedLanguage })}
        >
          <SelectTrigger>
...
function CurriculumSelectorConfig({ data, updateData }: ConfigProps) {
  const curriculumData = data as Partial<CurriculumSelectorNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={curriculumData.subjectArea || ""}
          onValueChange={(value) => updateData({ subjectArea: value as SubjectArea })}
        >
          <SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-4">
          <Slider
            value={[curriculumData.difficultyAdjustment || 0]}
            min={-2}
            max={2}
            step={1}
            onValueChange={([value]) => updateData({ difficultyAdjustment: value as -2 | -1 | 0 | 1 | 2 })}
            className="flex-1"
          />
          <span className="text-sm font-medium w-8 text-center">
            {curriculumData.difficultyAdjustment && curriculumData.difficultyAdjustment > 0
              ? `+${curriculumData.difficultyAdjustment}`
              : curriculumData.difficultyAdjustment || 0}
          </span>
        </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={curriculumData.crossCurricular || false}
...
function ContentGeneratorConfig({ data, updateData }: ConfigProps) {
  const generatorData = data as Partial<ContentGeneratorNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={generatorData.contentType || "passage"}
          onValueChange={(value) => updateData({ contentType: value as ContentType })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        <Label>Length</Label>
        <Select
          value={generatorData.length || "medium"}
          onValueChange={(value) => updateData({ length: value as "short" | "medium" | "long" })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={generatorData.includeVisuals || false}
...
function AIModelConfig({ data, updateData }: ConfigProps) {
  const modelData = data as Partial<AIModelNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={modelData.provider || "openai"}
          onValueChange={(value) => updateData({ provider: value as AIProvider })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        <Label>Model</Label>
        <Select
          value={modelData.model || "gpt-4o-mini"}
          onValueChange={(value) => updateData({ model: value as AIModel })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        <Label>Temperature: {modelData.temperature ?? 0.7}</Label>
        <Slider
      ...
      <div className="space-y-2">
        ...
        <Input
          type="number"
          value={modelData.maxTokens || 1024}
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={modelData.streamResponse ?? true}
...
function PromptTemplateConfig({ data, updateData }: ConfigProps) {
  const templateData = data as Partial<PromptTemplateNodeData>
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={templateData.outputFormat || "text"}
          onValueChange={(value) => updateData({ outputFormat: value as PromptTemplateNodeData["outputFormat"] })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
...
function ScaffoldingConfig({ data, updateData }: ConfigProps) {
  const scaffoldingData = data as Partial<ScaffoldingNodeData>
  const scaffoldElements = (scaffoldingData.scaffoldElements || []) as string[]
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={scaffoldingData.scaffoldingType || "add-supports"}
          onValueChange={(value) => updateData({ scaffoldingType: value as ScaffoldingType })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={scaffoldingData.autoAdjust ?? true}
...
function L1BridgeConfig({ data, updateData }: ConfigProps) {
  const bridgeData = data as Partial<L1BridgeNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={bridgeData.bridgeType || "key-terms-only"}
          onValueChange={(value) => updateData({ bridgeType: value as BridgeType })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={bridgeData.displayMode || "inline"}
          onValueChange={(value) => updateData({ displayMode: value as BridgeDisplayMode })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={bridgeData.culturalContext ?? true}
...
function HumanInputConfig({ data, updateData }: ConfigProps) {
  const humanData = data as Partial<HumanInputNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={humanData.inputType || "text"}
          onValueChange={(value) => updateData({ inputType: value as InputType })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={humanData.hintAvailable ?? true}
...
function ComprehensionCheckConfig({ data, updateData }: ConfigProps) {
  const comprehensionData = data as Partial<ComprehensionCheckNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Input
          type="number"
          value={comprehensionData.questionCount || 3}
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-4">
          <Slider
            value={[comprehensionData.passThreshold || 70]}
            min={0}
            max={100}
            step={10}
            ...
            className="flex-1"
          />
          <span className="text-sm font-medium w-12">{comprehensionData.passThreshold || 70}%</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={comprehensionData.adaptiveQuestions ?? true}
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={comprehensionData.showFeedback ?? true}
...
function FeedbackConfig({ data, updateData }: ConfigProps) {
  const feedbackData = data as Partial<FeedbackNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={feedbackData.feedbackStyle || "growth-mindset"}
          onValueChange={(value) => updateData({ feedbackStyle: value as FeedbackStyle })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={feedbackData.encouragementLevel || "high"}
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={feedbackData.includeCorrectAnswer ?? true}
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={feedbackData.l1Support ?? false}
...
function ProficiencyRouterConfig({ data, updateData }: ConfigProps) {
  const routerData = data as Partial<ProficiencyRouterNodeData>
  ...
  return (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={routerData.routingCriteria?.type || "elpa-level"}
          onValueChange={(value) =>
            updateData({ routingCriteria: { ...(routerData.routingCriteria || {}), type: value as RoutingCriteria["type"] } })
          }
        >
          <SelectTrigger>
            <SelectValue />
      ...
      <div className="space-y-2">
        ...
        <Input
          value={routerData.defaultPath || "track"}
...
function GenericConfig({ data, updateData }: ConfigProps) {
  const genericData = data as ConfigData
  ...
  return (
    <div className="space-y-2">
      ...
      <Textarea
        id="description"
        value={(genericData.description as string) || ""}
