...
import type { AllNodeTypes, NodeCategory, BaseNodeData } from "@/lib/types/nodes"
...
function PromptTemplateContent({ data }: Omit<NodeContentProps, "type">) {
  return (
...
function VisualSupportContent({ data }: Omit<NodeContentProps, "type">) {
  return (
    <div className="space-y-1 text-xs text-muted-foreground">
      <div className="flex items-center gap-2">
...
function VariableContent({ data }: Omit<NodeContentProps, "type">) {
  return (
    <div className="space-y-1 text-xs text-muted-foreground">
      {data?.variableName ? (
...
function ContentGeneratorContent({ data }: Omit<NodeContentProps, "type">) {
  return (
    <div className="space-y-1 text-xs text-muted-foreground">
      <div className="flex items-center gap-2">
